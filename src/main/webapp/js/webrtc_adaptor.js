...
export class WebRTCAdaptor {
    ...
    sendStartRemoteDesktopControl(rdcHostId){
        console.log("SENDING START REMOTE DESKTOP CONTROL")
    ...
    sendStopRemoteDesktopControl(rdcHostId){
        console.log("SENDING STOP REMOTE DESKTOP CONTROL")
